...
GET  /api/history?code=X&e=X → {history:[{t,c,i,o,g}], historyCoarse:[{t,c,i,o}], total, capacity, totalIn, totalOut, groups:[{id,name,count,totalIn,totalOut,opStats}]}  // c=présents(net) ; i/o=cumuls entrées/sorties ; g={groupId:count} ; history=fin 60s/48h ; historyCoarse=5min/60j
